...
#ifndef SpaceDroneSourceParams_H
#define SpaceDroneSourceParams_H
...
static const AkPluginParamID PARAM_DENSITY_ID = 1;
static const AkPluginParamID PARAM_RND_ID = 2;
static const AkPluginParamID PARAM_DYNAMIC_ID = 3;

static const AkUInt32 NUM_PARAMS = 4;

struct SpaceDroneRTPCParams
{
    AkReal32 fDuration;
    AkInt16 fDensity;
    AkReal32 fRnd;
...
struct SpaceDroneNonRTPCParams
{
};

struct SpaceDroneSourceParams
    : public AK::IAkPluginParam
{
    SpaceDroneSourceParams();
    SpaceDroneSourceParams(const SpaceDroneSourceParams& in_rParams);
    ...
    SpaceDroneRTPCParams RTPC;
    SpaceDroneNonRTPCParams NonRTPC;
};

#endif // SpaceDroneSourceParams_H
